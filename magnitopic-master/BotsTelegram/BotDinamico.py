        ...
        if len(all_updates) > 0:
            for current_update in all_updates:
                ...
                if first_chat_text == 'hi' or first_chat_text == 'Hi' or first_chat_text == 'hey' or first_chat_text == 'Hey':
                    ...
                    walle_bot.send_message(first_chat_id,'Hi ' + first_chat_name + '\nWelcome to BMSCE')
                    new_offset = first_update_id + 1
                    ...
                    new_offset = first_update_id + 1
                elif first_chat_text == 'profile photo' or first_chat_text == 'dp':
                    walle_bot.send_photo(first_chat_id,'AgADBQADdqkxG-dOkVZh2mq1bm6HJUgnGzMABAEAAwIAA20AA3VUAAIWBA')
                    new_offset = first_update_id + 1
